    ...
    <footer className="relative z-10 bg-[#f3e8d8] px-6 py-12 lg:px-16 border-t-2 border-[#e8dcc2]">
      <div className="mx-auto grid max-w-[1600px] gap-8 md:grid-cols-2 lg:grid-cols-4 items-start">
          ...
          <ul className="flex flex-col gap-2">
            {sideNav.map((item) => (
              <li key={item.to}>
                <Link
                  to={item.to}
                  className="font-body text-[19px] font-bold text-foreground transition-colors hover:text-olive"
                >
                  {item.label}
                </Link>
              </li>
        ...
        <div className="space-y-4">
          <p className="font-body text-[19px] text-foreground">
          ...
          <p className="font-body text-[18px] text-foreground">
        ...
        <div className="space-y-3">
          ...
          <iframe
            ...
            className="h-[170px] w-full max-w-[340px] rounded-2xl border-0 shadow-[0_2px_8px_oklch(0_0_0/0.12)]"
          />
        </div>
      </div>
    </footer>
